...
?>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="kelola_price.php"> Manajemen Price </a>/</span> Ubah data</h4>
                    ...
                    <input type="hidden" name="id_price" value="<?= $data['id_price']; ?>">
                            <div class="row">
                               ...
                               <div class="mb-3">
                                ...
                                placeholder="Hour" value="<?= $data['hour']; ?>" required 
                                />
                                </div>
                                <div class="mb-3">
                                ...
                                class="form-control"
                                id="exampleFormControlInput1"
                                placeholder="Enhanced Photos" value="<?= $data['enhanced_photos']; ?>" required
                                />
                                </div>
                               </div>
                               <div class="col-lg-3">
