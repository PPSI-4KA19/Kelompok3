...
<!-- Content -->
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manajemen /</span> Price</h4>
                ...
                <div class="card-header">
                  <div class="card-title">
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="float-end">
                          <a href="tambah_price.php" class="btn btn-primary">
                  ...
                  <table class="table">
                    <thead>
                      <tr class="text-nowrap">
                        ...
                        <th class="text-center bg-primary text-white">Hour </th>
                        <th class="text-center bg-primary text-white">Enhanced Photos</th>
                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        <td class="text-center"><?= $row['enhanced_photos'] ?></td>
                        <td class="text-center"><?= $row['status_publish'] ?></td>
                        <td class="text-center">
                          <a href="edit.php?id=<?= $row['id_price']; ?>" class="btn btn-sm btn-warning">Ubah</a>
                          <a href="proses_aksi.php?id=<?= $row['id_price']; ?>&aksi=delete" class="btn btn-sm 
