...
<!-- Content -->
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="kelola_category.php"> Manajemen Category </a>/</span> Tambah data</h4>
                    ...
                    <div class="card-body">
                        <form action="proses_aksi.php?aksi=add" method="POST" enctype="multipart/form-data">
                            <div class="row">
                               <div class="col-lg-9">
                               <div class="mb-3">
                               <select class="form-control" id="exampleselect" name="jenis_category" placeholder="Select category" required>
                               ...
                               <div class="col-md mb-3">
                                ...
                                <div class="mb-3">
                                <label for="uploadHeader" class="form-label">Gambar*</label>
                                <input
                                type="file"
                                name="header"
                                class="form-control"
