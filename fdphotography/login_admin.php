              ...
              <p class="mb-4">
                ...
                if(isset($_GET['pesan'])){
                  ...
                  echo '<i class="text-danger">Login Gagal! Username atau password tidak sesuai! ';
                    ...
                    echo '<i class="text-danger">Username dan Password tidak boleh kosong! ';
                  } else if($_GET['pesan'] == 'notfound'){
                    echo '<i class="text-danger">Username tidak tersedia! ';
                  } else if($_GET['pesan'] == 'logout'){
                    echo '<i class="text-danger">Anda telah berhasil logout. ';
                  } else if($_GET['pesan'] == 'notlogin'){
                    echo '<i class="text-danger">Anda harus login untuk mengakses halaman admin! ';
                  } 
                }
                ?>
              </p>
